...
<body>
			...
			<table class="table table-hover table-bordered table-list">
				<thead>
					<tr>
						...
						<th width="60"><?php echo L('AUTHOR');?></th>
						<th width="60"><?php echo L('PUBLISH_DATE');?></th>
				...
				<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
					...
					<td><img class="tdc" style="height:30px;width:30px" onmousemove='tdc("http://<?php echo ($_SERVER["HTTP_HOST"]); ?>/admin/<?php echo ($vo["tdc"]); ?>")' src="http://<?php echo ($_SERVER['HTTP_HOST']); ?>/admin/<?php echo ($vo["tdc"]); ?>" /></td>
					<td>
					<a href="<?php echo U('portal/article/index',array('id'=>$vo['tid']));?>" target="_blank"> <span><?php echo ($vo["post_title"]); ?></span></a></td>
					<td><?php echo ($terms[$vo['term_id']]); echo ($terms[$vo['tdc']]); ?></td>
	...
	<div onclick="atchide()"   class='atc3'  style="display:none;height:300px;width:300px;position:absolute;top:50%;left:47%;margin:-200px 0 0 -150px;z-index:9999;background-color:red; "><img src='' class='atc2' style='height:300px;width:300px;'></div>
		...
		$(function() {
			...
			Wind.use('ajaxForm', 'artDialog', 'iframeTools', function() {
				...
				$('.js-articles-move').click(function(e) {
					...
					var $this = $(this);
					art.dialog.open("/admin/index.php?g=portal&m=AdminPost&a=move&ids="+ id, {
						title : "批量移动",
						width : "80%"
					});
				});
