...
<body>
							...
							<td>
								<div style="text-align: center;">
									...
									<a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
										<img src="/admin/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id="thumb_preview" width="135" style="cursor: hand" />
									</a>
									<input type="button" class="btn btn-small" onclick="$('#thumb_preview').attr('src','/admin/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png');$('#thumb').val('');return false;" value="取消图片">
								</div>
							</td>
						</tr>
						<tr>
	...
	<script type="text/javascript" src="/admin/Public/js/common.js"></script>
	<script type="text/javascript" src="/admin/Public/js/content_addtop.js"></script>
	<script type="text/javascript">
		//编辑器路径定义
		var editorURL = GV.DIMAUB;
	</script>
	<script type="text/javascript" src="/admin/Public/js/ueditor/ueditor.config.js"></script>
	<script type="text/javascript" src="/admin/Public/js/ueditor/ueditor.all.min.js"></script>
	<script type="text/javascript">
		$(function() {
